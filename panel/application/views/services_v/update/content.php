                ...
                <form action="<?php echo base_url("services/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <?php foreach ($icons as $icon) { if($icon->icon_code == $item->icon_code) { ?>
                                <option selected value="<?php echo $icon->icon_code; ?>"><?php echo $icon->icon_name; ?></option><?php }else{ ?><option value="<?php echo $icon->icon_code; ?>"><?php echo $icon->icon_name; ?></option>
                                <?php } ?>
                            <?php } ?>
                            </select>
                        </div>

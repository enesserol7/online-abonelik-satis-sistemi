                        ...
                        <?php foreach($items as $item) { ?>
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center w200">
                                    ...
                                    <button data-url="<?php echo base_url("product_categories/delete/$item->id"); ?>" class="btn btn-sm btn-danger btn-outline remove-btn"><i class="fa fa-trash"></i> Sil</button><?php } ?>
                                    <?php if (isAllowedUpdateModule()) { ?>
                                    <a href="<?php echo base_url("product_categories/update_form/$item->id"); ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a><?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>

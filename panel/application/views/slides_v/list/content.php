...
<!--                                    <img width="75" src="--><?php //echo base_url("uploads/$viewFolder/$item->img_url"); ?><!--" alt="" class="img-rounded">-->
                                    <img width="75" src="<?php echo get_picture($viewFolder,$item->img_url, "1000x700"); ?>" alt="" class="img-rounded">
                                </td>
                                <td class="text-center w100">
                                    <input
                                ...
                                <td class="text-center w200">
                                    ...
                                    <button data-url="<?php echo base_url("slides/delete/$item->id"); ?>" class="btn btn-sm btn-danger btn-outline remove-btn"><i class="fa fa-trash"></i> Sil</button>
                                    <?php } ?>

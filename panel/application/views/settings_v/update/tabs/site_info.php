<div role="tabpanel" class="tab-pane in active fade" id="tab-1">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <input class="form-control" placeholder="Diğer telefon numaranız (opsiyonel)" name="phone_2" value="<?php echo isset($form_error) ? set_value("phone_2") : $item->phone_2; ?>">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            <label>Fax 2</label>
            <input class="form-control" placeholder="Diğer fax numaranız (opsiyonel)" name="fax_2" value="<?php echo isset($form_error) ? set_value("fax_2") : $item->fax_2; ?>">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-4">
            <label>İban</label>
            <input class="form-control" placeholder="İban numaranız" name="iban" value="<?php echo isset($form_error) ? set_value("iban") : $item->iban; ?>">
        </div>
    </div>
</div>
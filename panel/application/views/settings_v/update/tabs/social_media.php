<div role="tabpanel" class="tab-pane fade" id="tab-5">
    <div class="row">
        <div class="form-group col-md-8">
            ...
            <input class="form-control" placeholder="Şirketinize ait e-posta adresi" name="email" value="<?php echo isset($form_error) ? set_value("email") : $item->email; ?>">
    ...
    <div class="row">
        <div class="form-group col-md-4">
            <label>Youtube (Sadece Kullanıcı Adı Giriniz...)</label>
            <input class="form-control" placeholder="Youtube Adresiniz" name="youtube" value="<?php echo isset($form_error) ? set_value("youtube") : $item->youtube; ?>">
        </div>
    </div>
</div>
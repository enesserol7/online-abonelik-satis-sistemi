                		...
                		<tr id="ord-<?php echo $item->id; ?>">
                            ...
                            <td class="text-center w300">
                                <?php if ($item->news_type == "image") { ?>
                                    <img width="75" src="<?php echo get_picture($viewFolder, $item->img_url, "570x480"); ?>" alt="" class="img img-responsive">
                        	...
                        	<td class="text-center w200">
                            	...
                            	<button data-url="<?php echo base_url("news/delete/$item->id"); ?>" class="btn btn-sm btn-danger btn-outline remove-btn"><i class="fa fa-trash"></i> Sil</button><?php } ?>
                                <?php if (isAllowedUpdateModule()) { ?>
                            	<a href="<?php echo base_url("news/update_form/$item->id"); ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a><?php } ?>
                        	</td>
                    	</tr>
                	<?php } ?>                    
                </tbody>

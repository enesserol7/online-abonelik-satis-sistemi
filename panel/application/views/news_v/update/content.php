                ...
                <form action="<?php echo base_url("news/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php } else { ?>
                        <div class="row">
                            <div class="col-md-1 image_upload_container">
                                <img src="<?php echo get_picture($viewFolder, $item->img_url, "570x480"); ?>" class="img img-responsive">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control" name="news_keyw" cols="4" rows="5"><?php echo $item->page_keyw; ?></textarea>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Haber Açıklama SEO (En Fazla 255 Karakter Giriniz!)</label>
                            <textarea class="form-control" name="news_desc" cols="4" rows="5"><?php echo $item->page_desc; ?></textarea>
                        </div>
                    </div>

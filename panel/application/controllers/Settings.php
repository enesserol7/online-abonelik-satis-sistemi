...
class Settings extends MY_Controller{
    ...
    public function save(){
        ...
        if($validate){
            ...
            $image_160x44 = upload_picture($_FILES["logo"]["tmp_name"], "uploads/$this->viewFolder",160,44, $file_name);
            $image_150x40 = upload_picture($_FILES["mobile_logo"]["tmp_name"], "uploads/$this->viewFolder",150,40, $file_name);
            $image_32x32  = upload_picture($_FILES["favicon"]["tmp_name"], "uploads/$this->viewFolder",32,32, $file_name);
            if($image_160x44 && $image_150x40 && $image_32x32){
